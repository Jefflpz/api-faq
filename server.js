...
app.post("/pergunta",authMiddleware , async (req, res) => {
  try {
    ...
    const prompt = `Você é um assistente de respostas rápidas e precisa sempre responder perguntas mesmo que não tenha certeza...: ${pergunta}`;
